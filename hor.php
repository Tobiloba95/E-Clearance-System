...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (empty($_POST["hor_name"])) {
            $nameErr = "Hall Supervisor's is required";
        } else {
            $name = test_input($_POST["hor_name"]);
    ...
    <p>This student is hereby cleared and can proceed to vacate the Hall of Residence.</p>
    <form method="post" action="ict.php">
        <input type="text" name="hor_name" placeholder="Name of Hall Supervisor...">
